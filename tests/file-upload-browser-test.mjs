 ...
 *   3. send -> both render as reference cards (path only, file content is
 ...
 * Run:  npm run build && node tests/file-upload-browser-test.mjs */
...
async function main() {
	...
	// 4) Send; both files must be path references (content never injected).
